...
def cre_generator():
    ...
    net.compile(loss='binary_crossentropy', optimizer=keras.optimizers.RMSprop(lr=0.001, rho=0.9, epsilon=None, decay=0.0))
    return net
...
def cre_discriminator():
    ...
    net.compile(loss='binary_crossentropy', optimizer=keras.optimizers.RMSprop(lr=0.001, rho=0.9, epsilon=None, decay=0.0), metrics=['accuracy'])
    return net
...
def create_gan(discriminator, generator):
    ...
    gan.compile(loss='binary_crossentropy', optimizer=keras.optimizers.RMSprop(lr=0.001, rho=0.9, epsilon=None, decay=0.0))
    return gan
