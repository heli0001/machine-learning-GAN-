...
d_trainer_fake = tf.train.AdamOptimizer(0.01).minimize(d_loss_fake, var_list=d_vars)
d_trainer_real = tf.train.AdamOptimizer(0.01).minimize(d_loss_real, var_list=d_vars)
# Train the generator
